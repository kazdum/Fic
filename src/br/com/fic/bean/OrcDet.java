 ...
 */
@Entity
@Table(name = "orc_det", catalog = "fic_java", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "OrcDet.findByQtdOrcDet", query = "SELECT o FROM OrcDet o WHERE o.qtdOrcDet = :qtdOrcDet"),
...
public class OrcDet implements Serializable {
    ...
    @Column(name = "QTD_ORC_DET")
    private int qtdOrcDet;
    ...
    public OrcDet(OrcDetPK orcDetPK, int qtdOrcDet) {
        this.orcDetPK = orcDetPK;
        this.qtdOrcDet = qtdOrcDet;
    }
    ...
    public int getQtdOrcDet() {
        return qtdOrcDet;
    }

    public void setQtdOrcDet(int qtdOrcDet) {
        int oldQtdOrcDet = this.qtdOrcDet;
        this.qtdOrcDet = qtdOrcDet;
        changeSupport.firePropertyChange("qtdOrcDet", oldQtdOrcDet, qtdOrcDet);
    }
    ...
    public String toString() {
        return "br.com.fic.bean.OrcDet[ orcDetPK=" + orcDetPK + " ]";
    }
