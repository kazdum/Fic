 ...
 */
@Entity
@Table(name = "cot_det", catalog = "fic_java", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "CotDet.findByCodReqCab", query = "SELECT c FROM CotDet c WHERE c.cotDetPK.codReqCab = :codReqCab"),
    @NamedQuery(name = "CotDet.findByQtdeCotDet", query = "SELECT c FROM CotDet c WHERE c.qtdeCotDet = :qtdeCotDet"),
    ...
    @NamedQuery(name = "CotDet.findByUni5", query = "SELECT c FROM CotDet c WHERE c.uni5 = :uni5"),
...
public class CotDet implements Serializable {
    ...
    public Double getUni5() {
        return uni5;
    }

    public void setUni5(Double uni5) {
        Double oldUni5 = this.uni5;
        this.uni5 = uni5;
        changeSupport.firePropertyChange("uni5", oldUni5, uni5);
    }
    ...
    public String toString() {
        return "br.com.fic.view.compras.CotDet[ cotDetPK=" + cotDetPK + " ]";
    }
