 ...
 */
@Entity
@Table(name = "pedido_det", catalog = "fic_java", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "PedidoDet.findByCodCotCab", query = "SELECT p FROM PedidoDet p WHERE p.pedidoDetPK.codCotCab = :codCotCab"),
    @NamedQuery(name = "PedidoDet.findByCodProduto", query = "SELECT p FROM PedidoDet p WHERE p.pedidoDetPK.codProduto = :codProduto"),
    @NamedQuery(name = "PedidoDet.findByCodReqCab", query = "SELECT p FROM PedidoDet p WHERE p.pedidoDetPK.codReqCab = :codReqCab"),
...
public class PedidoDet implements Serializable {
    ...
    public String toString() {
        return "br.com.fic.view.compras.PedidoDet[ pedidoDetPK=" + pedidoDetPK + " ]";
    }
