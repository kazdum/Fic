...
public class FuncionarioView extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<br.com.fic.bean.Funcionario> toRemove = new ArrayList<br.com.fic.bean.Funcionario>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.com.fic.bean.Funcionario f = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(f);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.fic.bean.Funcionario f = new br.com.fic.bean.Funcionario();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.fic.bean.Funcionario> merged = new ArrayList<br.com.fic.bean.Funcionario>(list.size());
            for (br.com.fic.bean.Funcionario f : list) {
    ...
    private java.util.List<br.com.fic.bean.Funcionario> list;
