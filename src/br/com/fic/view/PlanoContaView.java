...
public class PlanoContaView extends JPanel {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<br.com.fic.bean.PlanoConta> toRemove = new ArrayList<br.com.fic.bean.PlanoConta>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.com.fic.bean.PlanoConta p = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(p);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.fic.bean.PlanoConta p = new br.com.fic.bean.PlanoConta();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.fic.bean.PlanoConta> merged = new ArrayList<br.com.fic.bean.PlanoConta>(list.size());
            for (br.com.fic.bean.PlanoConta p : list) {
    ...
    private java.util.List<br.com.fic.bean.PlanoConta> list;
