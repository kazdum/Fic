 ...
 * @author i3
 */
public class ReqCompra extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                ReqCompra.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                ReqCompra.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                ReqCompra.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                ReqCompra.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                ReqCompra.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                ReqCompra.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        br.com.fic.bean.ReqCab R = list.get(masterTable.convertRowIndexToModel(index));
        Collection<br.com.fic.bean.ReqDet> rs = R.getReqDetList();
        int[] selected = detailTable.getSelectedRows();
        List<br.com.fic.bean.ReqDet> toRemove = new ArrayList<br.com.fic.bean.ReqDet>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<br.com.fic.bean.ReqDet> iter = rs.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            br.com.fic.bean.ReqDet r = iter.next();
            toRemove.add(r);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<br.com.fic.bean.ReqDet> rs = R.getReqDetList();
        if (rs == null) {
            rs = new LinkedList<br.com.fic.bean.ReqDet>();
            R.setReqDetList((List) rs);
        }
        br.com.fic.bean.ReqDet r = new br.com.fic.bean.ReqDet();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<br.com.fic.bean.ReqCab> toRemove = new ArrayList<br.com.fic.bean.ReqCab>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            br.com.fic.bean.ReqCab R = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(R);
            entityManager.remove(R);
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        br.com.fic.bean.ReqCab R = new br.com.fic.bean.ReqCab();
        entityManager.persist(R);
        list.add(R);
        int row = list.size() - 1;
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<br.com.fic.bean.ReqCab> merged = new ArrayList<br.com.fic.bean.ReqCab>(list.size());
            for (br.com.fic.bean.ReqCab R : list) {
    ...
    private java.util.List<br.com.fic.bean.ReqCab> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReqCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new ReqCompra());
